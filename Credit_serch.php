...
{
  echo("<tr><td>".$row['comp_name']."</td><td><a target='_blank' href='Credit.php?serch=".$row['comp_name']." ' class='btn btn-primary btn-lg active' role='button' aria-pressed='true'>Credit</a></td></tr>");
}
}
